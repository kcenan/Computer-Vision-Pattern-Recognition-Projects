...
ground_truth_correspondence_file = '921919841_a30df938f2_o_to_4191453057_c86028ce1f_o.mat';
...
for i = 1:length(x1_est)
    ...
    subplot(1,2,1);
    hold on;
    plot(y1_est(i),x1_est(i), 'o', 'LineWidth',2, 'MarkerEdgeColor',edgeColor,...
                       'MarkerFaceColor', cur_color, 'MarkerSize',10)
    hold off;

    subplot(1,2,2);
    hold on;
    plot(y2_est(i), x2_est(i), 'o', 'LineWidth',2, 'MarkerEdgeColor',edgeColor,...
                       'MarkerFaceColor', cur_color, 'MarkerSize',10)
    hold off;
end
